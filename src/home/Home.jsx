...
import HomeSection2 from './section2/HomeSection2.jsx'; // Import the HomeSection2 component
import Section3Home from './section3/Section3Home.jsx'; // Import the Section3Home component

// Mock Spline wrapper with error handling
const Model3D = ({ mousePosition }) => {
  ...
  useEffect(() => {
    const loadSpline = async () => {
      try {
        await new Promise((resolve) => setTimeout(resolve, 1000)); // Simulate Spline loading
        setIsLoaded(true);
      } catch (error) {
...
const Homepage = () => {
  ...
  const downloadCV = () => {
    window.open('/path-to-your-cv.pdf', '_blank'); // Replace with actual CV path
  };
